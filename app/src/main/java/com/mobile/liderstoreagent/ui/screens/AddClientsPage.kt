...
class AddClientsPage : Fragment(R.layout.add_client_page) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (page == 1) {
            ...
            address1.hint = "Ism Familiya"
            director.visibility = View.GONE
            mashrut.visibility = View.GONE
                    ...
                    if (addClientData != null) {
                        db.clientDao().insertClient(
                            ClientEntity(
                                ...
                                addClientData.responsible_agent,
                                addClientData.director_phone_number,
                                addClientData.work_phone_number,
                                addClientData.latitude,
                                addClientData.longitude,
                                addClientData.image.path,
                                addClientData.sale_agents,
                                addClientData.INN,
                                addClientData.director,
                                addClientData.birthdate,
                                addClientData.car,
                                addClientData.market_type,
